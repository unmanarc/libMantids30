...
public:
    ...
    void setFromString(const std::string & varName, CX2::Memory::Abstract::Type varType, const std::string & str);
    /**
     ...
     */
    void set(const std::string & varName, CX2::Memory::Abstract::Var * var);
    /**
     ...
     */
    CX2::Memory::Abstract::Var * get(const std::string & varName);
...
private:
    std::map<std::string, CX2::Memory::Abstract::Var *> vars;
