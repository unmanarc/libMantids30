...
public:
    ...
    virtual CX2::Memory::Containers::B_Base * getValue(const std::string & varName) = 0;
    virtual std::list<CX2::Memory::Containers::B_Base *> getValues(const std::string & varName) = 0;
