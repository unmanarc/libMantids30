...
protected:
    ...
    void eventUnexpectedAnswerReceived(CX2::RPC::Fast::FastRPC_Connection *connection, const std::string &answer) override
    {
    }
    void eventFullQueueDrop(CX2::RPC::Fast::sFastRPCParameters * params) override
    {
    }
...
public:
     ...
     * @return
     */
    int processFastRPCConnection(CX2::Network::Streams::StreamSocket *stream);
protected:
