...
bool Manager_SQLite3::attribAdd(const std::string &attribName, const std::string &attribDescription)
{
    bool ret = false;
...
bool Manager_SQLite3::attribRemove(const std::string &attribName)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool Manager_SQLite3::attribGroupAdd(const std::string &attribName, const std::string &groupName)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool Manager_SQLite3::attribGroupRemove(const std::string &attribName, const std::string &groupName, bool lock)
{
    bool ret = false;
    if (lock) mutex.lock();
...
bool Manager_SQLite3::attribAccountAdd(const std::string &attribName, const std::string &accountName)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool Manager_SQLite3::attribAccountRemove(const std::string &attribName, const std::string &accountName, bool lock)
{
    bool ret = false;
    if (lock) mutex.lock();
...
bool Manager_SQLite3::attribChangeDescription(const std::string &attribName, const std::string &attribDescription)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
std::string Manager_SQLite3::attribDescription(const std::string &attribName)
{
    std::string ret;
...
std::set<std::string> Manager_SQLite3::attribsList()
{
...
std::set<std::string> Manager_SQLite3::attribGroups(const std::string &attribName, bool lock)
{
    std::set<std::string> ret;
...
std::set<std::string> Manager_SQLite3::attribAccounts(const std::string &attribName, bool lock)
{
    std::set<std::string> ret;
    if (lock) mutex.lock_shared();
...
bool Manager_SQLite3::accountValidateDirectAttribute(const std::string &accountName, const std::string &attribName)
{
    bool ret=false;
    Threads::Sync::Lock_RD lock(mutex);
