...
bool IAuth_Volatile::attribAdd(const std::string &attribName, const std::string &attribDescription)
{
...
bool IAuth_Volatile::attribRemove(const std::string &attribName)
{
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_Volatile::attribGroupAdd(const std::string &attribName, const std::string &groupName)
{
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_Volatile::attribGroupRemove(const std::string &attribName, const std::string &groupName, bool lock)
{
    bool ret = false;
    if (lock) mutex.lock();
...
bool IAuth_Volatile::attribAccountAdd(const std::string &attribName, const std::string &accountName)
{
    bool ret = false;
...
bool IAuth_Volatile::attribAccountRemove(const std::string &attribName, const std::string &accountName, bool lock)
{
    bool ret = false;
    if (lock) mutex.lock();
...
bool IAuth_Volatile::attribChangeDescription(const std::string &attribName, const std::string &attribDescription)
{
...
std::string IAuth_Volatile::attribDescription(const std::string &attribName)
{
...
std::set<std::string> IAuth_Volatile::attribsList()
{
...
std::set<std::string> IAuth_Volatile::attribGroups(const std::string &attribName, bool lock)
{
    std::set<std::string> ret;
...
std::set<std::string> IAuth_Volatile::attribAccounts(const std::string &attribName, bool lock)
{
    std::set<std::string> ret;
    if (lock) mutex.lock_shared();
...
bool IAuth_Volatile::accountValidateDirectAttribute(const std::string &accountName, const std::string &attribName)
{
    bool ret=false;
    Threads::Sync::Lock_RD lock(mutex);
