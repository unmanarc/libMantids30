...
enum AuthReason
{
    ...
    AUTH_REASON_INVALID_DOMAIN=994,      // AUTHENTICATION FAILED.
...
static const char * cAUTH_REASON_INVALID_DOMAIN = "Invalid domain name";
...
static const char * getAuthReasonText(const AuthReason & reason)
{
    ...
    case AUTH_REASON_INVALID_DOMAIN: return cAUTH_REASON_INVALID_DOMAIN;
    }
    return cNULL;
}
