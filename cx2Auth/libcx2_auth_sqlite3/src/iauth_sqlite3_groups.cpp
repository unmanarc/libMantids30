...
bool IAuth_SQLite3::groupAdd(const std::string &groupName, const std::string &groupDescription)
{
    bool ret = false;
...
bool IAuth_SQLite3::groupRemove(const std::string &groupName)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_SQLite3::groupExist(const std::string &groupName)
{
    bool ret = false;
...
bool IAuth_SQLite3::groupAccountAdd(const std::string &groupName, const std::string &accountName)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_SQLite3::groupAccountRemove(const std::string &groupName, const std::string &accountName, bool lock)
{
    bool ret = false;
...
bool IAuth_SQLite3::groupChangeDescription(const std::string &groupName, const std::string &groupDescription)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_SQLite3::groupValidateAttribute(const std::string &groupName, const std::string &attribName, bool lock)
{
    bool ret = false;
...
std::string IAuth_SQLite3::groupDescription(const std::string &groupName)
{
    std::string ret;
    Threads::Sync::Lock_RD lock(mutex);
...
std::set<std::string> IAuth_SQLite3::groupsList()
{
...
std::set<std::string> IAuth_SQLite3::groupAttribs(const std::string &groupName, bool lock)
{
    std::set<std::string> ret;
    if (lock) mutex.lock_shared();
...
std::set<std::string> IAuth_SQLite3::groupAccounts(const std::string &groupName, bool lock)
{
    std::set<std::string> ret;
    if (lock) mutex.lock_shared();
