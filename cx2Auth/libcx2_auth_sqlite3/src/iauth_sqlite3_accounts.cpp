...
bool IAuth_SQLite3::accountAdd(const std::string &accountName, const DataStructs::sPasswordData &passData, const std::string &email, const std::string &accountDescription, const std::string &extraData, time_t expirationDate, bool enabled, bool confirmed, bool superuser)
{
    bool ret = false;
...
std::string IAuth_SQLite3::accountConfirmationToken(const std::string &accountName)
{
    std::string ret;
...
bool IAuth_SQLite3::accountRemove(const std::string &accountName)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_SQLite3::accountDisable(const std::string &accountName, bool disabled)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_SQLite3::accountConfirm(const std::string &accountName, const std::string &confirmationToken)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_SQLite3::accountChangePassword(const std::string &accountName, const DataStructs::sPasswordData &passwordData, uint32_t passIndex)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_SQLite3::accountChangeDescription(const std::string &accountName, const std::string &description)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_SQLite3::accountChangeEmail(const std::string &accountName, const std::string &email)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_SQLite3::accountChangeExtraData(const std::string &accountName, const std::string &extraData)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_SQLite3::accountChangeExpiration(const std::string &accountName, time_t expiration)
{
    bool ret = false;
    Threads::Sync::Lock_RW lock(mutex);
...
bool IAuth_SQLite3::isAccountDisabled(const std::string &accountName)
{
    bool ret = true;
    Threads::Sync::Lock_RD lock(mutex);
...
bool IAuth_SQLite3::isAccountConfirmed(const std::string &accountName)
{
    bool ret = false;
    Threads::Sync::Lock_RD lock(mutex);
...
bool IAuth_SQLite3::isAccountSuperUser(const std::string &accountName)
{
    bool ret = false;
    Threads::Sync::Lock_RD lock(mutex);
...
std::string IAuth_SQLite3::accountDescription(const std::string &accountName)
{
    std::string ret;
    Threads::Sync::Lock_RD lock(mutex);
...
std::string IAuth_SQLite3::accountEmail(const std::string &accountName)
{
    std::string ret;
    Threads::Sync::Lock_RD lock(mutex);
...
std::string IAuth_SQLite3::accountExtraData(const std::string &accountName)
{
    std::string ret;
    Threads::Sync::Lock_RD lock(mutex);
...
time_t IAuth_SQLite3::accountExpirationDate(const std::string &accountName)
{
...
std::set<std::string> IAuth_SQLite3::accountsList()
{
...
std::set<std::string> IAuth_SQLite3::accountGroups(const std::string &accountName, bool lock)
{
    std::set<std::string> ret;
...
std::set<std::string> IAuth_SQLite3::accountDirectAttribs(const std::string &accountName, bool lock)
{
    std::set<std::string> ret;
    if (lock) mutex.lock_shared();
...
DataStructs::sPasswordData IAuth_SQLite3::retrievePassword(const std::string &accountName, uint32_t passIndex, bool *found)
{
    DataStructs::sPasswordData ret;
    Threads::Sync::Lock_RD lock(mutex);
    ...
    *found = false;
    ...
    if (s == SQLITE_ROW)
    {
        *found = true;
        ...
        ret.passwordMode = (DataStructs::PasswordModes)sqlite3_column_int(stmt, 2);
