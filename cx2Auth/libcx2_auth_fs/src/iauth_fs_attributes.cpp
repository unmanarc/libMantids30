...
bool IAuth_FS::_pAttribDirCreate(const std::string &attribName, std::string &attribsDirOut)
{
...
bool IAuth_FS::_pAttribsDir( std::string &accountsDirOut)
{
    if (access(workingAuthDir.c_str(), W_OK)) return false;
...
std::set<std::string> IAuth_FS::attribsList()
{
...
bool IAuth_FS::attribAdd(const std::string &attribName, const std::string &attribDescription)
{
...
bool IAuth_FS::attribRemove(const std::string &attribName)
{
...
bool IAuth_FS::attribGroupAdd(const std::string & attribName, const std::string & groupName)
{
...
bool IAuth_FS::attribGroupRemove(const std::string &attribName, const std::string &groupName, bool lock)
{
    std::string groupDir, groupAttribsDir;
    std::string attribDir, attribGroupsDir;
    bool r=false;
...
bool IAuth_FS::attribAccountAdd(const std::string &attribName, const std::string &accountName)
{
...
bool IAuth_FS::attribAccountRemove(const std::string &attribName, const std::string &accountName, bool lock)
{
    std::string accountDir, accountAttribsDir;
    std::string attribDir, attribAccountsDir;
...
bool IAuth_FS::attribChangeDescription(const std::string &attribName, const std::string &attribDescription)
{
    bool r = false;
    std::string attribDir;
    Threads::Sync::Lock_RW lock(mutex);
...
std::string IAuth_FS::attribDescription(const std::string &attribName)
{
    std::string r;
    std::string attribDir;
    Threads::Sync::Lock_RD lock(mutex);
...
std::set<std::string> IAuth_FS::groupAttribs(const std::string &groupName, bool lock)
{
    std::set<std::string> attribs;
    std::string groupDir, groupAttribsDir;
    bool r = false;
...
std::set<std::string> IAuth_FS::attribGroups(const std::string &attribName, bool lock)
{
...
std::set<std::string> IAuth_FS::attribAccounts(const std::string &attribName, bool lock)
{
...
std::set<std::string> IAuth_FS::accountDirectAttribs(const std::string &accountName, bool lock)
{
    std::set<std::string> attribs;
...
bool IAuth_FS::accountValidateDirectAttribute(const std::string &accountName, const std::string &attribName)
{
...
bool IAuth_FS::groupValidateAttribute(const std::string &groupName, const std::string &attribName, bool lock)
{
...
std::string IAuth_FS::getAttribDetailsFilePath(const std::string &attribName)
{
