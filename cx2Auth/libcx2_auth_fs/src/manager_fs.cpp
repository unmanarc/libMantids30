...
Manager_FS::Manager_FS(const std::string &appName, const std::string &dirPath)
{
...
bool Manager_FS::_pTouchFile(const std::string &fileName, const std::string &value)
{
    std::ofstream ofstr;
    ofstr.open(fileName);
...
bool Manager_FS::_pRemFile(const std::string &fileName)
{
    return !unlink(fileName.c_str());
}

std::set<std::string> Manager_FS::_pListDir(const std::string &dirPath)
{
...
bool Manager_FS::_pWorkingAuthDir( std::string &workingDirOut)
{
