...
private:
    ...
    std::string getPasswordFilePath(const std::string & accountName, uint32_t passIndex);
...
/*    bool saveFile_Activation(const std::string & accountName, const Json::Value & v);
    ...
    bool saveFile_Password(const std::string & accountName, uint32_t passIndex, const Json::Value & v);*/
