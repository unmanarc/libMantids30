...
#include <cx2_prg_service/globalarguments.h>
...
protected:
     ...
     */
    virtual void rpcInitVars(int argc, char *argv[], CX2::Application::Arguments::GlobalArguments * globalArguments)=0;
    /**
     ...
     * @return
     */
    virtual bool rpcConfig(int argc, char *argv[], CX2::Application::Arguments::GlobalArguments * globalArguments)=0;
    /**
     ...
     * @return
     */
    virtual int rpcStart(int argc, char *argv[], CX2::Application::Arguments::GlobalArguments * globalArguments)=0;
