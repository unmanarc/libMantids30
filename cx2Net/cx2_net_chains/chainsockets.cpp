...
ChainSockets::ChainSockets(CX2::Network::Streams::StreamSocket *_baseSocket, bool _deleteBaseSocketOnExit)
{
...
std::pair<CX2::Network::Streams::StreamSocket *, CX2::Network::Streams::StreamSocket *> ChainSockets::getSocketPairLayer(size_t layer)
{
    std::pair <CX2::Network::Streams::StreamSocket *, CX2::Network::Streams::StreamSocket *> bar;
...
bool ChainSockets::addToChain(std::pair<CX2::Network::Streams::StreamSocket *, CX2::Network::Streams::StreamSocket *> sockPairs, bool deleteFirstSocketOnExit, bool deleteSecondSocketOnExit, bool modeServer, bool detached, bool endPMode)
{
...
int ChainSockets::shutdownSocket(int mode)
{
    ...
    CX2::Network::Streams::StreamSocket * curSocket = !socketLayers.size()? baseSocket : ((sChainVectorItem *)socketLayers[socketLayers.size()-1])->sock[0];
