...
Mantids::Network::Streams::CryptoStream::CryptoStream(Mantids::Network::Streams::StreamSocket *socket)
{
    this->socket = socket;
}

std::pair<bool, bool> Mantids::Network::Streams::CryptoStream::mutualChallengeResponseSHA256Auth(const std::string &sharedKey, bool server)
{
    bool readOK;
