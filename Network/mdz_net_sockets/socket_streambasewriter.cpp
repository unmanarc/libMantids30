...
Socket_StreamBaseWriter::Socket_StreamBaseWriter()
{
...
bool Socket_StreamBaseWriter::writeU8(const unsigned char& c)
{
    unsigned char snd[1];
    snd[0] = c;
...
bool Socket_StreamBaseWriter::writeU16(const uint16_t& c)
{
...
bool Socket_StreamBaseWriter::writeU32(const uint32_t& c)
{
...
bool Socket_StreamBaseWriter::writeU64(const uint64_t &c)
{
    // Write 32bit unsigned integer as network long.
    uint64_t nbo;
    nbo = htonll(c);
