    ...
    const std::string &str)
{
    ...
    *this = CacheControl();
    ...
    for (const string &param : params)
    {
        ...
        if (paramLower == "no-store")
        {
            optionNoStore = true;
        }
        else if (paramLower == "no-cache")
        {
            optionNoCache = true;
        }
        else if (paramLower == "private")
        {
            optionPrivate = true;
        }
        else if (paramLower == "public")
        {
            optionPublic = true;
        }
        else if (paramLower == "immutable")
        {
            optionImmutable = true;
        }
        else if (paramLower == "proxy-revalidate")
        {
            optionProxyRevalidate = true;
        }
        else if (paramLower == "no-transform")
        {
            optionNoTransform = true;
        }
