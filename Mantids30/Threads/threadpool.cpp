...
bool ThreadPool::pushTask(void (*task)(const std::shared_ptr<void> &), std::shared_ptr<void> taskData, uint32_t timeoutMS, const float &priority, const std::string &key)
{
