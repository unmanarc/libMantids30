...
public:
     ...
     */
    bool pushTask(void (*task)(const std::shared_ptr<void> &), const std::shared_ptr<void> &taskData, uint32_t timeoutMS = static_cast<uint32_t>(-1), const float &priority = 0.5,
