...
Socket_Chain::Socket_Chain(Mantids30::Network::Sockets::Socket_Stream_Base *_baseSocket, bool _deleteBaseSocketOnExit)
{
...
std::pair<Mantids30::Network::Sockets::Socket_Stream_Base *, Mantids30::Network::Sockets::Socket_Stream_Base *> Socket_Chain::getSocketPairLayer(size_t layer)
{
    std::pair <Mantids30::Network::Sockets::Socket_Stream_Base *, Mantids30::Network::Sockets::Socket_Stream_Base *> bar;
...
bool Socket_Chain::addToChain(std::pair<Mantids30::Network::Sockets::Socket_Stream_Base *, Mantids30::Network::Sockets::Socket_Stream_Base *> sockPairs, bool deleteFirstSocketOnExit, bool deleteSecondSocketOnExit, bool modeServer, bool detached, bool endPMode)
{
...
bool Socket_Chain::isConnected()
{
    ...
    Mantids30::Network::Sockets::Socket_Stream_Base * curSocket = !socketLayers.size()? baseSocket : ((sChainVectorItem *)socketLayers[socketLayers.size()-1])->sock[0];
