...
public:
    ...
    struct MonolithAPIMethod
    {
         ...
         */
        json (*method)(void * obj, Mantids30::Auth::Session * session, const json & parameters);
        /**
    ...
    int invoke(Mantids30::Auth::Session *session, const std::string &methodName, const json &payload, json *payloadOut);

    eMethodValidationCodes validateMethodRequirements(Mantids30::Auth::Session *session, const std::string & methodName, json * reasons);

    Mantids30::Auth::MethodsRequirements_Map * methodsRequirements();
...
private:
    ...
    Mantids30::Auth::MethodsRequirements_Map m_methodsPermissions;
