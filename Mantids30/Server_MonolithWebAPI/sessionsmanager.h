...
public:
    WebSession()
    {
      ...
      //  bAuthTokenConfirmed = false;
        //sCSRFAuthConfirmToken = Mantids30::Helpers::Random::createRandomString(32);
        sCSRFToken = Mantids30::Helpers::Random::createRandomString(32);
    }
    ...
    Mantids30::Auth::Session * authSession;
...
public:
     ...
     * @return Session ID
     */
    std::string createWebSession(Mantids30::Auth::Session * session);
