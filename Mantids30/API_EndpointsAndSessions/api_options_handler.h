...
struct OptionsHandlerConfig
{
     ...
     */
    [[nodiscard]] bool allowsAllOrigins() const;
     ...
     */
    [[nodiscard]] bool allowsOrigin(const std::string &origin) const;
