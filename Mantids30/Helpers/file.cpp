...
bool Mantids30::Helpers::File::writeStringToFile(const std::string &filePath, const std::string &content)
{
...
bool Mantids30::Helpers::File::fixSensitiveConfigPermission(const std::string &configFilePath)
{
#ifndef _WIN32
