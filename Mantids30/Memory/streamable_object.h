...
public:
     ...
     */
    virtual size_t size() { return std::numeric_limits<size_t>::max(); }
     ...
     */
    virtual bool streamTo(Memory::Streams::StreamableObject *out) { return true; }
