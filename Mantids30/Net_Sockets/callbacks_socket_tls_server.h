...
public:
     ...
     */
    void (*onTLSListeningSuccess)(void * obj, Mantids30::Network::Sockets::Socket_TLS *);
    /**
     * @brief onTLSListeningFailed Callback to Notify if the socket failed to listen
     */
    void (*onTLSListeningFailed)(void * obj, Mantids30::Network::Sockets::Socket_TLS *);
    /**
     * @brief onTLSClientDisconnected Callback to Notify just after one client was disconnected (including the CN)
     */
    void (*onTLSClientDisconnected)(void * obj, Mantids30::Network::Sockets::Socket_TLS *, const std::string &, int);
    /**
     * @brief onTLSClientConnected Callback to Notify when a TLS client has been connected (including the CN)
     */
    void (*onTLSClientConnected)(void * obj, Mantids30::Network::Sockets::Socket_TLS *, const std::string &);
    /**
     ...
     */
    bool (*onTLSClientAuthenticationError)(void * obj, Mantids30::Network::Sockets::Socket_Stream_Base *, const char *, bool);
    /**
     * @brief onTLSClientAcceptTimeoutOccurred Callback to Notify when the acceptor failed to allocate a thread
     */
    void (*onTLSClientAcceptTimeoutOccurred)(void * obj, Mantids30::Network::Sockets::Socket_Stream_Base *, const char *, bool);
    /**
     ...
     */
    void (*onTLSClientConnectionLimitPerIPReached)(void * obj, Mantids30::Network::Sockets::Socket_Stream_Base *, const char *);
};
