...
public:
    ...
    public:
        ...
        /**
         * @brief Path to the Certificate Authority (CA) PEM file for verifying client certificates.
         *        If this is empty, client authentication will not be enforced.
         */
        std::string tlsCACertificatePath;

        /**
         * @brief Path to the private key file (PEM format) for the server's TLS certificate.
         */
