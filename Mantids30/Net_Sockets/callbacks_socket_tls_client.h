...
public:
     ...
     */
    void (*onTLSConnectionStart)(void * obj, Mantids30::Network::Sockets::Socket_TLS * , const std::string & , const uint16_t &) = nullptr;
    /**
     * @brief onTLSDisconnected Callback to Notify just after the TLS/TCP-IP Connection (with the error code as integer)
     */
    void (*onTLSDisconnected)(void * obj, Mantids30::Network::Sockets::Socket_TLS *, const std::string & , const uint16_t &, int) = nullptr;
    /**
     ...
     */
    void (*onTLSConnectionSuccess)(void * obj, Mantids30::Network::Sockets::Socket_TLS * ) = nullptr;
    /**
     * @brief onTLSConnectionFailed Callback to Notify when there is an error during the TLS/TCP-IP Connection
     */
    bool (*onTLSConnectionFailed)(void * obj, Mantids30::Network::Sockets::Socket_TLS *, const std::string &, const uint16_t & ) = nullptr;
