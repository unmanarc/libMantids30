...
public:
     ...
     */
    void (*onListeningSuccess)(void *context,const std::shared_ptr<Sockets::Socket_Stream> &) = nullptr;
    /**
     * @brief onListeningFailed Callback to Notify if the socket failed to listen
     */
    void (*onListeningFailed)(void *context,const std::shared_ptr<Sockets::Socket_Stream> &) = nullptr;
    /**
     * @brief onClientDisconnected Callback to Notify just after one client was disconnected
     */
    void (*onClientDisconnected)(void *context,const std::shared_ptr<Sockets::Socket_Stream> &, int) = nullptr;
    /**
     * @brief onClientConnected Callback to Notify when a client has been connected
     */
    void (*onClientConnected)(void *context,const std::shared_ptr<Sockets::Socket_Stream> &) = nullptr;
    /**
     * @brief onClientAcceptTimeoutOccurred Callback to Notify when the acceptor failed to allocate a thread
     */
    void (*onClientAcceptTimeoutOccurred)(void *context,const std::shared_ptr<Sockets::Socket_Stream> &) = nullptr;
    /**
     ...
     */
    void (*onClientConnectionLimitPerIPReached)(void *context, const std::shared_ptr<Sockets::Socket_Stream> &) = nullptr;
};
