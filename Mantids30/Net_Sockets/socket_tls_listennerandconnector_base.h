...
public:
    ...
    public:
        ...
        */
        void (*onTLSConnectionRetriesReached)(void * obj, Mantids30::Network::Sockets::Socket_TLS * , const std::string & , const uint16_t &);
    ...
    virtual int handleConnection(Mantids30::Network::Sockets::Socket_TLS * stream, bool remotePeerIsServer, const char * remotePair) = 0;


    std::atomic_bool m_stopReconnecting;

private:
    static bool incommingConnection(void *obj, Mantids30::Network::Sockets::Socket_Stream_Base * bsocket, const char *, bool secure);
