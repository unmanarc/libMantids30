...
public:
    ...
    static CX2::Authentication::Manager *getAuthManager();
    static void setAuthManager(CX2::Authentication::Manager *value);
...
private:
    ...
    static CX2::Authentication::Manager * authManager;
