...
// TODO: todas las funciones para administrar el sitio web como admin? (template fullauth)...
bool WebServerImpl::createWebServer()
{
    ...
    if (sockWebListen->listenOn(listenPort ,listenAddr.c_str(), !Globals::getConfig_main()->get<bool>("WebServer.ipv6",false) ))
    {
        ...
        std::string resourcesPath = Globals::getConfig_main()->get<std::string>("WebServer.ResourcesPath","/var/www/cx2_authserver");
