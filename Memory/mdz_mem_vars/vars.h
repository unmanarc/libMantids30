...
public:
    ...
    virtual Mantids::Memory::Containers::B_Base * getValue(const std::string & varName) = 0;
    virtual std::list<Mantids::Memory::Containers::B_Base *> getValues(const std::string & varName) = 0;
