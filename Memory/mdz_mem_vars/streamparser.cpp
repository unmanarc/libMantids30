...
using namespace Mantids::Memory::Streams::Parsing;

Parser::Parser(Memory::Streams::Streamable *value, bool clientMode)
{
...
Status Parser::parseObject(ParseErrorMSG *err)
{
    bool ret;
    Status upd;
...
bool Parser::streamTo(Memory::Streams::Streamable *out, Status &wrsStat)
{
    return false;
}

Status Parser::write(const void *buf, const size_t &count, Status &wrStat)
{
    Status ret;
    // Parse this data...
    size_t ttl = 0;
...
void Parser::setStreamable(Memory::Streams::Streamable *value)
{
