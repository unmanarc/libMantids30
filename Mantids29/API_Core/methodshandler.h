...
namespace Mantids29 { namespace Network { namespace API {
...
public:
     ...
     */
    bool addMethod(const std::string & methodName, const std::set<std::string> & reqAttribs, const sRPCMethod & rpcMethod, bool requireFullAuth = true);
    /**
