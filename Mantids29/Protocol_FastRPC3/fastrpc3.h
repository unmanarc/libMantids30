...
public:
    ...
    struct TaskParameters
    {
        ...
        Mantids29::API::Monolith::MethodsHandler *methodsHandler;
    ...
    struct CallbackDefinitions {
        ...
        void * obj = nullptr;
        // Mantids29::Auth::getReasonText(authReason) < - to obtain the auth reason.
    };
     ...
     * @return
     */
    int handleConnection(Mantids29::Network::Sockets::Socket_TLS * stream, bool remotePeerIsServer, const char * remotePair);
...
private:
    ...
    Mantids29::Threads::Safe::Map<std::string> m_connectionMapById;
