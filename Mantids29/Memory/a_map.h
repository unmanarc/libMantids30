...
public:
    ...
    void setFromString(const std::string & varName, Mantids29::Memory::Abstract::Var::Type varType, const std::string & str);
    /**
     ...
     */
    void set(const std::string & varName, Mantids29::Memory::Abstract::Var * var);
    /**
     ...
     */
    Mantids29::Memory::Abstract::Var * get(const std::string & varName);
...
private:
    std::map<std::string, Mantids29::Memory::Abstract::Var *> vars;
