...
using namespace Mantids29::Memory::Streams;
...
size_t SubParser::ParseValidator(Mantids29::Memory::Containers::B_Base &bc)
{
...
Mantids29::Memory::Containers::B_Base *SubParser::getParsedBuffer()
{
    return &parsedBuffer;
}
...
uint64_t SubParser::getLastBytesInCommon(const std::string &boundary)
{
    ...
    {
        Mantids29::Memory::Containers::B_Ref ref = referenceLastBytes(v);
...
Mantids29::Memory::Containers::B_Ref SubParser::referenceLastBytes(const size_t &bytes)
{
    Mantids29::Memory::Containers::B_Ref r;
