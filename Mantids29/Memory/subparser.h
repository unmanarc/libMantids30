...
protected:
     ...
     */
    virtual size_t ParseValidator(Mantids29::Memory::Containers::B_Base & bc);
    /**
     ...
     */
    Mantids29::Memory::Containers::B_Base * getParsedBuffer();
    /**
...
private:
    ...
    Mantids29::Memory::Containers::B_Ref referenceLastBytes(const size_t &bytes);

    Mantids29::Memory::Containers::B_Ref parsedBuffer;
    Mantids29::Memory::Containers::B_Chunks unparsedBuffer;
