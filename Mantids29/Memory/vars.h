...
public:
     ...
     */
    virtual Mantids29::Memory::Streams::StreamableObject * getValue(const std::string & varName) = 0;
    /**
     * @brief getValues Get all the memory containers associated with a variable name
     * @param varName variable name
     * @return list of memory containers abstracts
     */
    virtual std::list<Mantids29::Memory::Streams::StreamableObject *> getValues(const std::string & varName) = 0;
    /**
