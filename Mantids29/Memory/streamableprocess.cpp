...
Mantids29::Memory::Streams::StreamableProcess::StreamableProcess(Helpers::AppSpawn *spawner)
{
    this->spawner = spawner;
}

Mantids29::Memory::Streams::StreamableProcess::~StreamableProcess()
{
    delete this->spawner;
}

bool Mantids29::Memory::Streams::StreamableProcess::streamTo(StreamableObject *out, Status &wrStatUpd)
{
    Status cur;
    for (;;)
    {
...
Mantids29::Memory::Streams::StreamableObject::Status Mantids29::Memory::Streams::StreamableProcess::write(const void *buf, const size_t &count, Status &wrStatUpd)
{
    // TODO:
    Mantids29::Memory::Streams::StreamableObject::Status status;
