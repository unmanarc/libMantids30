...
struct CommandLineOption {
    CommandLineOption() {
        ...
        shortOption = 0;
        isMandatory = true;
        optionType = Mantids29::Memory::Abstract::Var::TYPE_BOOL;
    }
    ...
    Mantids29::Memory::Abstract::Var::Type optionType; /**< The type of the variable for the option. */

    Mantids29::Memory::Abstract::Var* defaultValVar; /**< A pointer to the variable holding the default value. */
    std::list<Mantids29::Memory::Abstract::Var*> parsedOption; /**< A list of pointers to variables holding the parsed option values. */
...
public:
     ...
     */
    Mantids29::Memory::Abstract::Var * getCommandLineOptionValue(const std::string & optionName );
    /**
     * @brief getCommandLineOptionValues Get Command Line Option Values (As list of abstracts)
     * @param optionName Option Name (Full name)
     * @return option values list
     */
    std::list<Mantids29::Memory::Abstract::Var *> getCommandLineOptionValues(const std::string & optionName );
     ...
     */
    bool addStaticVariable(const std::string & name, Mantids29::Memory::Abstract::Var * var);
    /**
     ...
     */
    Mantids29::Memory::Abstract::Var * getStaticVariable(const std::string & name);
...
private:
    ...
    // Variables:
    std::map<std::string,Mantids29::Memory::Abstract::Var *> m_variables; // variable name -> variable
    Mantids29::Threads::Sync::Mutex_Shared m_variablesMutex;
};
