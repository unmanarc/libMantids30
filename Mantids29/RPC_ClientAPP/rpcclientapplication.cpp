...
void RPCClientApplication::_initvars(int argc, char *argv[], Mantids29::Application::Arguments::GlobalArguments *globalArguments)
{
    // init program vars.
...
bool RPCClientApplication::_config(int argc, char *argv[], Mantids29::Application::Arguments::GlobalArguments *globalArguments)
{
...
#endif
    // process config here.
    unsigned int logMode = Mantids29::Application::Logs::MODE_STANDARD;

    Logs::AppLog initLog(Mantids29::Application::Logs::MODE_STANDARD);
    ...
    // LOGS OPTIONS
    // Use syslog option:
    if ( Globals::getLC_LogsUsingSyslog() ) logMode|=Mantids29::Application::Logs::MODE_SYSLOG;
    // Applog instance
...
int RPCClientApplication::_start(int argc, char *argv[], Mantids29::Application::Arguments::GlobalArguments *globalArguments)
{
    auto masterKey = Globals::getMasterKey();
