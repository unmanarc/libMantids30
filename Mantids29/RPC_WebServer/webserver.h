...
public:
    ...
    struct sWebServerCallBack
    {
        ...
        sWebServerCallBack( bool (*callbackFunction)(void *, Network::Sockets::Socket_Stream_Base *, const char *, bool) )
        {
     ...
     */
    void setAuthenticator(Mantids29::Authentication::Domains *value);
    /**
    ...
    Mantids29::Authentication::Domains *getAuthenticator() const;
...
private:
    ...
    std::map<std::string,Mantids29::Memory::Containers::B_MEM *> staticContentElements;
    ...
    Mantids29::Authentication::Domains * authenticator;
