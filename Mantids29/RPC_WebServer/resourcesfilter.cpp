...
void Mantids29::RPC::Web::ResourcesFilter::addFilter(const sFilter &filter)
{
    filters.push_back(filter);
}

Mantids29::RPC::Web::ResourcesFilter::sFilterEvaluation ResourcesFilter::evaluateAction(const std::string &uri, Mantids29::Authentication::Session * hSession, Mantids29::Authentication::Manager * authorizer)
{
