...
class RPCClientApplication : public Mantids29::Program::Application
{
public:
    ...
    void _shutdown();
    void _initvars(int argc, char *argv[], Mantids29::Program::Arguments::GlobalArguments * globalArguments);
    bool _config(int argc, char *argv[], Mantids29::Program::Arguments::GlobalArguments * globalArguments);
    int _start(int argc, char *argv[], Mantids29::Program::Arguments::GlobalArguments * globalArguments);
...
protected:
     ...
     */
    virtual void rpcInitVars(int argc, char *argv[], Mantids29::Program::Arguments::GlobalArguments * globalArguments)=0;
    /**
     ...
     * @return
     */
    virtual bool rpcConfig(int argc, char *argv[], Mantids29::Program::Arguments::GlobalArguments * globalArguments)=0;
    /**
     ...
     * @return
     */
    virtual int rpcStart(int argc, char *argv[], Mantids29::Program::Arguments::GlobalArguments * globalArguments)=0;
