...
bool MethodsHandler::addResource(const MethodMode &mode, const std::string &resourceName,void (*method)(APIReturn & ,void * ,Mantids29::Auth::ClientDetails &,const json &,json &,const DataFormat::JWT::Token & , const RESTful::RequestParameters & ), void *obj, const uint32_t & SecurityOptions, const std::set<std::string> requiredPermissions)
{
...
/*
    ...
    {
        Mantids29::Auth::ClientDetails clientDetails = extractClientDetails(inputParameters);
