...
// Define the specialization of std::hash for TokenCacheKey inside the Mantids29::Auth namespace
namespace std {
template <>
struct hash<Mantids29::Auth::TokenCacheKey> {
    size_t operator()(const Mantids29::Auth::TokenCacheKey& key) const {
        return key.hash();
    }
};
}
