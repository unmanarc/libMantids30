...
public:
    ...
    struct TaskParameters
    {
        ...
        MethodsManager *currentMethodsManagers;
    ...
    public:
                ...
                )
        {
            ...
            this->currentMethodsManagers = currentMethodsManagers;

            this->defaultLoginRPCClient = currentLoginRPCClient;
            this->defaultAuthDomains = currentAuthDomains;
            this->defaultMethodsManagers = currentMethodsManagers;
        ...
        ~ParametersDefinitions()
        {
            ...
            if ( defaultMethodsManagers != currentMethodsManagers )
                delete currentMethodsManagers;
        ...
        Authentication::LoginRPCClientCBM * currentLoginRPCClient;
        /**
         * @brief currentMethodsManagers current Methods Manager
         */
        MethodsManager *currentMethodsManagers;
        /**
    ...
    private:
        ...
        MethodsManager *defaultMethodsManagers;
