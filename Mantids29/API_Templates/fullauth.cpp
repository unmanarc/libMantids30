#include "fullauth.h"
#include <regex>
using namespace Mantids29::Network::API::Templates;
using namespace Mantids29;

std::string FullAuth::dirAppName;

void FullAuth::AddFullAuthMethods(API::MethodsHandler *methods, const std::string &_dirAppName)
{
    dirAppName = _dirAppName;

    // Accounts:
    methods->addMethod("accountAdd", {"DIRWRITE"}, {&accountAdd,nullptr});
    methods->addMethod("accountExist",{"DIRREAD"},{&accountExist,nullptr});
    methods->addMethod("accountChangeSecret", {"DIRWRITE"}, {&accountChangeSecret,nullptr});
    methods->addMethod("accountRemove", {"DIRWRITE"}, {&accountRemove,nullptr});
    methods->addMethod("accountDisable", {"DIRWRITE"}, {&accountDisable,nullptr});
    methods->addMethod("accountConfirm", {"DIRWRITE"}, {&accountConfirm,nullptr});
    methods->addMethod("accountChangeBasicInfo", {"DIRWRITE"}, {&accountChangeBasicInfo,nullptr});
    methods->addMethod("accountChangeDescription", {"DIRWRITE"}, {&accountChangeDescription,nullptr});
    methods->addMethod("accountChangeGivenName", {"DIRWRITE"}, {&accountChangeGivenName,nullptr});
    methods->addMethod("accountChangeLastName", {"DIRWRITE"}, {&accountChangeLastName,nullptr});
    methods->addMethod("accountChangeEmail", {"DIRWRITE"}, {&accountChangeEmail,nullptr});
    methods->addMethod("accountChangeExtraData", {"DIRWRITE"}, {&accountChangeExtraData,nullptr});
    methods->addMethod("accountChangeExpiration", {"DIRWRITE"}, {&accountChangeExpiration,nullptr});
    methods->addMethod("accountChangeGroupSet", {"DIRWRITE"}, {&accountChangeGroupSet,nullptr});
    methods->addMethod("isAccountDisabled", {"DIRWRITE"}, {&isAccountDisabled,nullptr});
    methods->addMethod("isAccountConfirmed", {"DIRWRITE"}, {&isAccountConfirmed,nullptr});
    methods->addMethod("isAccountSuperUser", {"DIRWRITE"}, {&isAccountSuperUser,nullptr});
    methods->addMethod("accountGivenName", {"DIRREAD"}, {&accountGivenName,nullptr});
    methods->addMethod("accountLastName", {"DIRREAD"}, {&accountLastName,nullptr});
    methods->addMethod("accountBasicInfo", {"DIRREAD"}, {&accountBasicInfo,nullptr});
    methods->addMethod("accountDescription", {"DIRREAD"}, {&accountDescription,nullptr});
    methods->addMethod("accountEmail", {"DIRREAD"}, {&accountEmail,nullptr});
    methods->addMethod("accountExtraData", {"DIRREAD"}, {&accountExtraData,nullptr});
    methods->addMethod("isAccountExpired", {"DIRREAD"}, {&isAccountExpired,nullptr});
    methods->addMethod("validateAccountAttribute", {"DIRREAD"}, {&validateAccountAttribute,nullptr});
    methods->addMethod("accountsList", {"DIRREAD"}, {&accountsList,nullptr});
    methods->addMethod("accountsBasicInfoSearch", {"DIRREAD"}, {&accountsBasicInfoSearch,nullptr});
    methods->addMethod("accountGroups", {"DIRREAD"}, {&accountGroups,nullptr});
    methods->addMethod("accountDirectAttribs", {"DIRREAD"}, {&accountDirectAttribs,nullptr});
    methods->addMethod("accountUsableAttribs", {"DIRREAD"}, {&accountUsableAttribs,nullptr});
    methods->addMethod("accountExpirationDate", {"DIRREAD"}, {&accountExpirationDate,nullptr});
    methods->addMethod("accountLastLogin", {"DIRREAD"}, {&accountLastLogin,nullptr});
    methods->addMethod("resetBadAttempts", {"DIRWRITE"}, {&resetBadAttempts,nullptr});

    // Attribs:
    methods->addMethod("attribAdd", {"DIRWRITE"}, {&attribAdd,nullptr});
    methods->addMethod("attribRemove", {"DIRWRITE"}, {&attribRemove,nullptr});
    methods->addMethod("attribGroupAdd", {"DIRWRITE"}, {&attribGroupAdd,nullptr});
    methods->addMethod("attribGroupRemove", {"DIRWRITE"}, {&attribGroupRemove,nullptr});
    methods->addMethod("attribAccountAdd", {"DIRWRITE"}, {&attribAccountAdd,nullptr});
    methods->addMethod("attribAccountRemove", {"DIRWRITE"}, {&attribAccountRemove,nullptr});
    methods->addMethod("attribChangeDescription", {"DIRWRITE"}, {&attribChangeDescription,nullptr});
    methods->addMethod("attribDescription", {"DIRREAD"}, {&attribDescription,nullptr});
    methods->addMethod("attribsList", {"DIRREAD"}, {&attribsList,nullptr});
    methods->addMethod("attribGroups", {"DIRREAD"}, {&attribGroups,nullptr});
    methods->addMethod("attribAccounts", {"DIRREAD"}, {&attribAccounts,nullptr});
    methods->addMethod("attribsBasicInfoSearch", {"DIRREAD"}, {&attribsBasicInfoSearch,nullptr});
    methods->addMethod("attribsLeftListForGroup", {"DIRREAD"}, {&attribsLeftListForGroup,nullptr});

    //  Applications
    methods->addMethod("applicationBasicInfo", {"DIRREAD"}, {&applicationBasicInfo,nullptr});
    methods->addMethod("applicationAdd", {"DIRWRITE"}, {&applicationAdd,nullptr});
    methods->addMethod("applicationRemove", {"DIRWRITE"}, {&applicationRemove,nullptr});
    methods->addMethod("applicationExist", {"DIRREAD"}, {&applicationExist,nullptr});
    methods->addMethod("applicationDescription", {"DIRREAD"}, {&applicationDescription,nullptr});
    methods->addMethod("applicationChangeDescription", {"DIRWRITE"}, {&applicationChangeDescription,nullptr});
    methods->addMethod("applicationChangeKey", {"DIRWRITE"}, {&applicationChangeKey,nullptr});
    methods->addMethod("applicationList", {"DIRREAD"}, {&applicationList,nullptr});
    methods->addMethod("applicationValidateOwner", {"DIRREAD"}, {&applicationValidateOwner,nullptr});
    methods->addMethod("applicationValidateAccount", {"DIRREAD"}, {&applicationValidateAccount,nullptr});
    methods->addMethod("applicationOwners", {"DIRREAD"}, {&applicationOwners,nullptr});
    methods->addMethod("applicationAccounts", {"DIRREAD"}, {&applicationAccounts,nullptr});
    methods->addMethod("accountApplications", {"DIRREAD"}, {&accountApplications,nullptr});
    methods->addMethod("applicationAccountAdd", {"DIRWRITE"}, {&applicationAccountAdd,nullptr});
    methods->addMethod("applicationAccountRemove", {"DIRWRITE"}, {&applicationAccountRemove,nullptr});
    methods->addMethod("applicationOwnerAdd", {"DIRWRITE"}, {&applicationOwnerAdd,nullptr});
    methods->addMethod("applicationOwnerRemove", {"DIRWRITE"}, {&applicationOwnerRemove,nullptr});
    methods->addMethod("applicationsBasicInfoSearch", {"DIRREAD"}, {&applicationsBasicInfoSearch,nullptr});

    // Groups:
    methods->addMethod("groupAdd", {"DIRWRITE"}, {&groupAdd,nullptr});
    methods->addMethod("groupRemove", {"DIRWRITE"}, {&groupRemove,nullptr});
    methods->addMethod("groupExist", {"DIRREAD"}, {&groupExist,nullptr});
    methods->addMethod("groupAccountAdd", {"DIRWRITE"}, {&groupAccountAdd,nullptr});
    methods->addMethod("groupAccountRemove", {"DIRWRITE"}, {&groupAccountRemove,nullptr});
    methods->addMethod("groupChangeDescription", {"DIRWRITE"}, {&groupChangeDescription,nullptr});
    methods->addMethod("groupValidateAttribute", {"DIRREAD"}, {&groupValidateAttribute,nullptr});
    methods->addMethod("groupDescription", {"DIRREAD"}, {&groupDescription,nullptr});
    methods->addMethod("groupsList", {"DIRREAD"}, {&groupsList,nullptr});
    methods->addMethod("groupAttribs", {"DIRREAD"}, {&groupAttribs,nullptr});
    methods->addMethod("groupAccounts", {"DIRREAD"}, {&groupAccounts,nullptr});
    methods->addMethod("groupsBasicInfoSearch", {"DIRREAD"}, {&groupsBasicInfoSearch,nullptr});
    methods->addMethod("groupBasicInfo", {"DIRREAD"}, {&groupBasicInfo,nullptr});
...
json FullAuth::accountChangeSecret(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
    Mantids29::Authentication::Secret secretData;
...
json FullAuth::accountRemove(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::accountDisable(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::accountConfirm(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
    payloadOut["retCode"] = auth->accountDisable(JSON_ASSTRING(payload,"accountName",""), JSON_ASBOOL(payload,"disabled",false));
    return payloadOut;
...
json FullAuth::accountChangeDescription(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::accountChangeEmail(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::accountChangeExtraData(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::accountChangeExpiration(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::isAccountDisabled(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::isAccountConfirmed(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::isAccountSuperUser(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::accountDescription(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::accountEmail(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
    payloadOut["email"] = auth->accountEmail(JSON_ASSTRING(payload,"accountName",""));
    return payloadOut;
...
json FullAuth::accountExtraData(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
    payloadOut["extraData"] = auth->accountExtraData(JSON_ASSTRING(payload,"accountName",""));
    return payloadOut;
...
json FullAuth::accountExpirationDate(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::isAccountExpired(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::validateAccountAttribute(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
    payloadOut["isAccountExpired"] = auth->validateAccountAttribute(JSON_ASSTRING(payload,"accountName",""),  {JSON_ASSTRING(payload,"appName",""),JSON_ASSTRING(payload,"attribName","")});
    return payloadOut;
}

json FullAuth::accountsList(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::accountGroups(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::accountDirectAttribs(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::accountUsableAttribs(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::attribAdd(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::attribRemove(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::attribGroupAdd(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::attribGroupRemove(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::attribAccountAdd(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::attribAccountRemove(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::attribChangeDescription(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::attribsList(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::attribGroups(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::attribAccounts(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::groupAdd(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::groupRemove(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::groupExist(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::groupAccountAdd(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::groupAccountRemove(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::groupChangeDescription(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::groupValidateAttribute(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::groupDescription(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::groupsList(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::groupAttribs(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::groupAccounts(void *, Mantids29::Authentication::Manager *auth,Mantids29::Authentication::Session *session, const json &payload)
{
    json payloadOut;
...
json FullAuth::groupBasicInfo(void *obj, Authentication::Manager *auth, Authentication::Session *session, const json &payload)
{
    ...
    for (const auto & attrib : directAttribs)
    {
        ...
        x=0;
        for (const Mantids29::Authentication::ApplicationAttribute & attrib : auth->attribsList(attrib.appName))
        {
            if (directAttribs.find(attrib)==directAttribs.end())
            {
...
std::set<Authentication::ApplicationAttribute> FullAuth::iAttribsLeftListForGroup(Authentication::Manager *auth, const std::string &appName, const std::string &groupName)
{
