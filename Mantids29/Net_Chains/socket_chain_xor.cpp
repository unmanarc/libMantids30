...
using namespace Mantids29::Network::Sockets::ChainProtocols;
...
int Socket_Chain_XOR::partialRead(void *data, const uint32_t &datalen)
{
    ...
    int r = Mantids29::Network::Sockets::Socket::partialRead(data,datalen);
    if (r<=0) return r;
...
int Socket_Chain_XOR::partialWrite(const void *data, const uint32_t &datalen)
{
    ...
    int r = Mantids29::Network::Sockets::Socket::partialWrite(datacp,datalen);
    delete [] datacp;
    return r;
}
