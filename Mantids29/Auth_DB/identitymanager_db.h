...
public:
    ...
    IdentityManager_DB(Mantids29::Database::SQLConnector *_SQLDirConnection);
    bool initializeDatabase(std::string *adminPW) override;
    ...
    public:
        ...
        time_t getAccountExpirationDate(const std::string & accountName) override;
    ...
    {
    protected:
        Credential retrieveCredential(const std::string &accountName, uint32_t slotId, bool * accountFound, bool * authSlotFound) override;
    private:
        IdentityManager_DB *_parent;
    public:
        ...
        std::set<uint32_t> listAuthenticationSchemesForApplicationActivity(const std::string &appName, const std::string &activityName, bool useDefault = false) override;
        bool addAuthenticationSchemesToApplicationActivity(const std::string &appName, const std::string &activityName, uint32_t schemeId, bool isDefault = false) override;
        bool removeAuthenticationSchemeFromApplicationActivity( const std::string &appName, const std::string &activityName, uint32_t schemeId ) override;

        std::list<AuthenticationSchemeUsedSlot> listAuthenticationSlotsUsedByScheme(const uint32_t & schemeId) override;
    ...
    public:
        ...
        bool addWebLoginReturnURLToApplication(const std::string &appName, const std::string &loginReturnUrl) override;
        bool removeWebLoginReturnURLToApplication(const std::string &appName, const std::string &loginReturnUrl) override;
        std::list<std::string> listWebLoginReturnUrlsFromApplication(const std::string &appName) override;
        ...
        bool setApplicationActivities(const std::string &appName, const std::map<std::string, std::string> &activityNameAndDescription) override;
