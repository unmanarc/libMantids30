...
int MethodsManager::runRPCMethod(Mantids29::Authentication::Domains * authDomain, const std::string & domainName,Mantids29::Authentication::Session * session, const std::string & methodName, const json & payload,  json *payloadOut)
{
...
MethodsManager::eMethodValidationCodes MethodsManager::validateRPCMethodPerms(Mantids29::Authentication::Manager * auth, Mantids29::Authentication::Session *session, const std::string &methodName, const std::set<uint32_t> & extraTmpIndexes, json *reasons)
{
...
Mantids29::Authentication::MethodsAttributes_Map *MethodsManager::getMethodsAttribs()
{
...
std::set<Mantids29::Authentication::ApplicationAttribute> MethodsManager::getAppAttribs(const std::set<std::string> &reqAttribs)
{
...
json MethodsManager::toValue(const std::set<Mantids29::Authentication::ApplicationAttribute> &t)
{
    json x;
    int v=0;
    for (const auto &i : t)
